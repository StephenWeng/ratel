...
!function(t) {
    ...
    function G(t, e, n) {
        ...
        Math.abs(i) >= 1 && at(i) ? e.diff(t, "months", !0) / i : e.diff(t, "days", !0) / n.asDays())
    }
    function U(t, e) {
        var n, i;
        return _(t) || _(e) ? t / e : (n = t.asMonths(),
        i = e.asMonths(),
        Math.abs(n) >= 1 && at(n) && Math.abs(i) >= 1 && at(i) ? n / i : t.asDays() / e.asDays())
    }
    function W(t, n) {
        var i;
        return _(t) ? e.duration(t * n) : (i = t.asMonths(),
        Math.abs(i) >= 1 && at(i) ? e.duration({
            months: i * n
        }) : e.duration({
            days: t.asDays() * n
        }))
    ...
    function ct(n, i, r) {
        ...
        return e.isMoment(u) || q(u) || void 0 === u ? l = e.apply(null, n) : (s = !1,
        o = !1,
        c ? $t.test(u) ? (u += "-01",
        n = [u],
        s = !0,
        o = !0) : (a = Xt.exec(u)) && (s = !a[5],
        o = !0) : t.isArray(u) && (o = !0),
        ...
        function o(i) {
            ...
            return o && t.each(o.split(" "), function(n) {
                ...
                t.each(this.split(","), function(n, i) {
                    ...
                    c = !1) : ((s = a[i]) ? (d = function(t) {
                        s.click && s.click.call(y[0], t)
                    }
                    ,
                    (f = r.getCustomButtonIconClass(s)) || (f = r.getIconClass(i)) || (g = s.text)) : (h = e.getViewSpec(i)) ? (p.push(i),
                    d = function() {
                        e.changeView(i)
                    }
                    ,
                    ...
                    d && (m = ["fc-" + i + "-button", r.getClass("button"), r.getClass("stateDefault")],
                    g ? v = et(g) : f && (v = "<span class='" + f + "'></span>"),
                    y = t('<button type="button" class="' + m.join(" ") + '">' + v + "</button>").click(function(t) {
                        y.hasClass(r.getClass("stateDisabled")) || (d(t),
                        (y.hasClass(r.getClass("stateActive")) || y.hasClass(r.getClass("stateDisabled"))) && y.removeClass(r.getClass("stateHover")))
                    }).mousedown(function() {
                ...
                c && o.first().addClass(r.getClass("cornerLeft")).end().last().addClass(r.getClass("cornerRight")).end(),
                o.length > 1 ? (i = t("<div/>"),
                c && i.addClass(r.getClass("buttonGroup")),
                i.append(o),
                s.append(i)) : s.append(o)
            }),
            s
        }
        function a(t) {
    ...
    function It(t, e) {
        ...
        n = 0; n < t.length; n++)
            ...
            i.endMs > s && (s = i.endMs);
        return s < e.endMs && r.push(new Ue(s,e.endMs)),
        r
    }
    function Ht(t, e) {
    ...
    function Lt(t) {
        ...
        for (e = 0; e < t.length; e++) {
            for (n = t[e],
            i = 0; i < r.length && Vt(n, r[i]).length; i++)
                ;
            n.level = i,
            (r[i] || (r[i] = [])).push(n)
        }
    ...
    t.fn.fullCalendar = function(e) {
        ...
        return this.each(function(r, s) {
            ...
            "string" == typeof e ? "getCalendar" === e ? r || (i = l) : "destroy" === e ? l && (l.destroy(),
            a.removeData("fullCalendar")) : l ? t.isFunction(l[e]) ? (o = l[e].apply(l, n),
            r || (i = o),
            "destroy" === e && a.removeData("fullCalendar")) : Wt.warn("'" + e + "' is an unknown FullCalendar method.") : Wt.warn("Attempting to call a FullCalendar method on an element with no calendar.") : l || (l = new Le(a,e),
    ...
    ,
    Kt.local = function(t) {
        return Jt.local.call(this, this._ambigZone || t),
        this._ambigTime = !1,
        this._ambigZone = !1,
        this
    }
    ...
    function() {
        ...
        function n(t, e, n, s, o) {
            var a;
            return t = Wt.moment.parseZone(t),
    ...
    pe.mixin({
        ...
        initAutoScroll: function() {
            ...
            this.isAutoScroll && this.listenTo(t, "scroll", ut(this.handleDebouncedScroll, 100))
        },
    ...
    var ve = pe.extend({
        ...
        handleInteractionStart: function(t) {
            ...
            r && this.options.subjectCenter && (this.origHit && (e = I(this.origHit, e) || e),
            i = M(e)),
        ...
        handleDrag: function(t, e, n) {
            ...
            vt(i, this.hit) || (this.hit && this.handleHitOut(),
            i && this.handleHitOver(i))
        },
        handleDragEnd: function() {
            this.handleHitDone(),
            pe.prototype.handleDragEnd.apply(this, arguments)
        },
    ...
    var ye = dt.extend(se, {
        ...
        start: function(e) {
            ...
            S(e) ? this.listenTo(t(document), "touchmove", this.handleMove) : this.listenTo(t(document), "mousemove", this.handleMove))
        },
        stop: function(e, n) {
            function i() {
                r.isAnimating = !1,
    ...
    var De = dt.extend({
      ...
      , Ee = Wt.DateSelecting = De.extend({
        ...
        computeSelectionFootprint: function(t, e) {
            ...
            return n.sort(ot),
            new We(new Ue(n[0],n[3]),t.isAllDay)
        },
      ...
      , Se = Wt.EventDragging = De.extend({
        ...
        buildDragListener: function(t) {
            ...
            var g = this.dragListener = new ve(l,{
                ...
                dragStart: function(n) {
                    g.isTouch && !l.isEventDefSelected(d) && f && l.selectEventInstance(f),
                    e = !0,
                ...
                hitOver: function(e, o, h) {
                    ...
                    i ? (v = c.buildMutatedEventInstanceGroup(d.id, i),
                    m = a.isEventInstanceGroupAllowed(v)) : m = !1) : m = !1,
                    m || (i = null,
                    s()),
                    i && l.renderDrag(a.eventRangesToEventFootprints(v.sliceRenderRanges(a.dateProfile.renderUnzonedRange, u)), t, g.isTouch) ? n.hide() : n.show(),
                    o && (i = null)
                },
                hitOut: function() {
                    l.unrenderDrag(t),
        ...
        computeEventDateMutation: function(t, e) {
            ...
            return t.isAllDay !== e.isAllDay && (o = !0,
            e.isAllDay ? (l = !0,
            r.stripTime()) : a = !0),
      ...
      , Ce = Wt.EventResizing = De.extend({
        ...
        buildDragListener: function(t, e) {
            ...
            return this.dragListener = new ve(a,{
                ...
                hitOver: function(n, o, h) {
                    ...
                    p && v ? (i = e ? r.computeEventStartResizeMutation(p, v, t.footprint) : r.computeEventEndResizeMutation(p, v, t.footprint),
                    i ? (f = c.buildMutatedEventInstanceGroup(d.id, i),
                    g = a.isEventInstanceGroupAllowed(f)) : g = !1) : g = !1,
                    g ? i.isEmpty() && (i = null) : (i = null,
                    s()),
                    i && (l.hideEventsWithId(t.footprint.eventDef.id),
                    l.renderEventResize(a.eventRangesToEventFootprints(f.sliceRenderRanges(a.dateProfile.renderUnzonedRange, u)), t))
                },
                hitOut: function() {
                    i = null
                },
        ...
        computeEventStartResizeMutation: function(t, e, n) {
            ...
            return s.getStart().add(o) < s.getEnd() && (i = new sn,
            i.setStartDelta(o),
            r = new rn,
            r.setDateMutation(i),
            r)
        ...
        computeEventEndResizeMutation: function(t, e, n) {
            ...
            return s.getEnd().add(o) > s.getStart() && (i = new sn,
            i.setEndDelta(o),
            r = new rn,
            r.setDateMutation(i),
            r)
      ...
      , Re = Wt.ExternalDropping = De.extend(se, {
        ...
        handleDragStart: function(e, n) {
            ...
            (t.isFunction(r) ? r.call(i[0], i) : i.is(r)) && (this.isDragging || this.listenToExternalDrag(i, e, n)))
        },
        listenToExternalDrag: function(t, e, n) {
            ...
            (r.dragListener = new ve(a,{
                ...
                hitOver: function(t) {
                    ...
                    i ? (e = new Je(i.buildInstances()),
                    n = u.eventProps ? a.isEventInstanceGroupAllowed(e) : a.isExternalInstanceGroupAllowed(e)) : n = !1) : n = !1,
                    n || (i = null,
                    s()),
                    i && a.renderDrag(a.eventRangesToEventFootprints(e.sliceRenderRanges(a.dateProfile.renderUnzonedRange, l.calendar)))
                },
                hitOut: function() {
                    i = null
                },
                ...
                interactionEnd: function(e) {
                    i && l.reportExternalDrop(i, Boolean(u.eventProps), Boolean(u.stick), t, e, n),
                    r.isDragging = !1,
                    r.dragListener = null
                }
            })).startDrag(e)
        ...
        computeExternalDrop: function(e, n) {
            ...
            return e.isAllDay && (n.startTime ? s.time(n.startTime) : s.stripTime()),
            n.duration && (i = s.clone().add(n.duration)),
            s = r.applyTimezone(s),
            i && (i = r.applyTimezone(i)),
            $e.parse(t.extend({}, n.eventProps, {
                start: s,
                end: i
            }), new on(r))
        }
    ...
    var Te = Wt.EventPointing = De.extend({
        ...
        handleMouseover: function(t, e) {
            me.get().shouldIgnoreMouse() || this.mousedOverSeg || (this.mousedOverSeg = t,
      ...
      , He = Wt.EventRenderer = dt.extend({
        ...
        render: function(t) {
            ...
            for (e in t)
                ...
                n.getEventDef().hasBgRendering() ? s.push.apply(s, i) : o.push.apply(o, i);
            this.renderBgRanges(s),
      ...
      , Pe = Wt.HelperRenderer = dt.extend({
        ...
        renderEventFootprints: function(t, e, n, i) {
            ...
            for (s = this.eventRenderer.renderFgSegEls(s),
            r = 0; r < s.length; r++)
                s[r].el.addClass(o);
            if (null != i)
      ...
      , Fe = Wt.DateComponent = ze.extend({
        ...
        constructor: function() {
            ...
            this.fillRendererClass && (this.fillRenderer = new this.fillRendererClass(this)),
            this.eventRendererClass && (this.eventRenderer = new this.eventRendererClass(this,this.fillRenderer)),
            this.helperRendererClass && this.eventRenderer && (this.helperRenderer = new this.helperRendererClass(this,this.eventRenderer)),
            this.businessHourRendererClass && this.fillRenderer && (this.businessHourRenderer = new this.businessHourRendererClass(this,this.fillRenderer))
        },
        addChild: function(t) {
        ...
        executeEventRender: function(t) {
            ...
            this.eventRenderer.render(t)) : this.renderEvents && this.renderEvents(Dt(t)),
    ...
    Fe.mixin({
        buildGotoAnchorHtml: function(e, n, i) {
            ...
            n = n ? " " + rt(n) : "",
            i = i || "",
            !o && this.opt("navLinks") ? "<a" + n + '>' + i + "</a>" : "<span" + n + ">" + i + "</span>"
        },
        ...
        getDayClasses: function(t, e) {
            ...
            return this.dateProfile.activeUnzonedRange.containsDate(t) ? (r.push("fc-" + jt[t.day()]),
        ...
        computeDayRange: function(t) {
            var e = this._getCalendar()
              ...
              , r = +i.time()
              , s = i.clone().stripTime();
            return r && r >= this.nextDayThreshold && s.add(1, "days"),
    ...
    var ke = Wt.InteractiveDateComponent = Fe.extend({
        ...
        constructor: function() {
            Fe.call(this),
            this.dateSelectingClass && (this.dateClicking = new this.dateClickingClass(this)),
            this.dateSelectingClass && (this.dateSelecting = new this.dateSelectingClass(this)),
            this.eventPointingClass && (this.eventPointing = new this.eventPointingClass(this)),
            this.eventDraggingClass && this.eventPointing && (this.eventDragging = new this.eventDraggingClass(this,this.eventPointing)),
            this.eventResizingClass && this.eventPointing && (this.eventResizing = new this.eventResizingClass(this,this.eventPointing)),
            this.externalDroppingClass && (this.externalDropping = new this.externalDroppingClass(this))
        },
        setElement: function(t) {
        ...
        unrender: function() {
            ...
            Fe.prototype.unrender.apply(this, arguments)
        },
        executeEventUnrender: function() {
            this.endInteractions(),
      ...
      , Be = Wt.DayTableMixin = {
        ...
        renderHeadDateCellHtml: function(t, e, n) {
            ...
            return 1 === this.rowCnt ? s = s.concat(this.getDayClasses(t, !0)) : s.push("fc-" + jt[t.day()]),
        ...
        renderBgCellHtml: function(t, e) {
            ...
            return r.unshift("fc-day", n.calendar.theme.getClass("widgetContent")),
      ...
      , Ae = Wt.View = ke.extend({
        ...
        startNowIndicator: function() {
            var t, n, i, r = this;
            this.opt("nowIndicator") && (t = this.getNowIndicatorUnit()) && (n = lt(this, "updateNowIndicator"),
        ...
        updateSize: function(t, e, n) {
            this.setHeight ? this.setHeight(t, e) : ke.prototype.updateSize.apply(this, arguments),
        ...
        applyScroll: function(e) {
            e.isDateInit && this.isDatesRendered && t.extend(e, this.computeInitialDateScroll()),
    ...
    Ae.mixin({
        ...
        buildDateProfile: function(t, n, i) {
            ...
            a = this.buildRenderRange(this.trimHiddenDays(s.unzonedRange), s.unit, o),
        ...
        buildCurrentRangeInfo: function(t, e) {
            ...
            s = this.buildRangeFromDayCount(t, e, n)) : (s = this.buildCustomVisibleRange(t)) ? r = O(s.getStart(), s.getEnd()) : (i = this.getFallbackDuration(),
            r = O(i),
    ...
    Le.mixin({
        ...
        populateOptionsHash: function() {
            ...
            e = Oe[t],
            e || (t = Le.defaults.locale,
            e = Oe[t] || {}),
            i = tt(this.dynamicOverrides.isRTL, this.overrides.isRTL, e.isRTL, Le.defaults.isRTL),
            r = i ? Le.rtlDefaults : {},
            this.dirDefaults = r,
    ...
    Le.mixin({
        ...
        initMomentInternals: function() {
            ...
            this.optionsModel.watch("buildingMomentLocale", ["?locale", "?monthNames", "?monthNamesShort", "?dayNames", "?dayNamesShort", "?firstDay", "?weekNumberCalculation"], function(e) {
                ...
                null == r && "ISO" === i && (r = 1),
                null != r && (n = Object.create(s._week),
                n.dow = r,
                s._week = n),
        ...
        moment: function() {
            var t;
            return "local" === this.opt("timezone") ? (t = Wt.moment.apply(null, arguments),
            t.hasTime() && t.local()) : t = "UTC" === this.opt("timezone") ? Wt.moment.utc.apply(null, arguments) : Wt.moment.parseZone.apply(null, arguments),
        ...
        footprintToDateProfile: function(t, e) {
            ...
            return e || (n = Wt.moment.utc(t.unzonedRange.endMs)),
    ...
    Le.mixin({
        ...
        buildViewSpecOptions: function(t) {
            t.options = n([Le.defaults, t.defaults, this.dirDefaults, this.localeDefaults, this.overrides, t.overrides, this.dynamicOverrides]),
            Rt(t.options)
        },
        buildViewSpecButtonText: function(t, e) {
            ...
            t.buttonTextDefault = n(this.localeDefaults) || n(this.dirDefaults) || t.defaults.buttonText || n(Le.defaults) || (t.duration ? this.humanizeDuration(t.duration) : null) || e
        }
    }),
    Le.mixin({
        el: null,
        ...
        initialRender: function() {
            ...
            this.optionsModel.watch("settingBusinessHourGenerator", ["?businessHours"], function(t) {
                ...
                e.view && e.view.set("businessHourGenerator", e.businessHourGenerator)
            }, function() {
            ...
            this.opt("handleWindowResize") && t(window).resize(this.windowResizeProxy = ut(this.windowResize.bind(this), this.opt("windowResizeDelay")))
        },
        destroy: function() {
        ...
        renderView: function(e) {
            ...
            !this.view && e && (n = this.view = this.viewsByType[e] || (this.viewsByType[e] = this.instantiateView(e)),
            this.bindViewHandlers(n),
            n.setElement(t("<div class='fc-view fc-" + e + "-view' />").appendTo(this.contentEl)),
    ...
    Le.prototype.isFootprintAllowed = function(t, e, n, i, r) {
        var s, o;
        if (null != n && (s = this.constraintValToFootprints(n, t.isAllDay),
    ...
    Le.mixin({
        ...
        removeEvents: function(t) {
            ...
            if (null == t)
                ...
                r = Ct(r, t),
                n = 0; n < r.length; n++)
                    e = this.eventManager.getEventDefByUid(r[n]._id),
                    s[e.id] = !0;
                i.freeze();
                for (n in s)
        ...
        updateEvent: function(t) {
            ...
            i instanceof $e && (e = i.buildInstance(),
    ...
    var Ue = Wt.UnzonedRange = dt.extend({
        ...
        intersect: function(t) {
            ...
            (null === e || null === n || e < n) && (i = new Ue(e,n),
      ...
      , _e = dt.extend(re, {
        ...
        constructor: function(t, e, n) {
            ...
            this.end = e,
            this.timezone = n,
            this.unzonedRange = new Ue(t.clone().stripZone(),e.clone().stripZone()),
            this.requestsByUid = {},
            this.eventDefsByUid = {},
            this.eventDefsById = {},
        ...
        addEventInstance: function(t, e) {
            ...
            (n[e] || (n[e] = new Je)).eventInstances.push(t),
            this.tryRelease()
        },
      ...
      , qe = dt.extend(re, se, {
        ...
        requestEvents: function(t, e, n, i) {
            return !i && this.currentPeriod && this.currentPeriod.isWithinRange(t, e) && n === this.currentPeriod.timezone || this.setPeriod(new _e(t,e,n)),
        ...
        querySources: function(e) {
            ...
            for (n = 0; n < r.length; n++)
                if ((i = r[n]) === e)
                    return [i];
            return (i = this.getSourceById(on.normalizeId(e))) ? [i] : (e = an.parse(e, this.calendar),
            e ? t.grep(r, function(t) {
                return Mt(e, t)
            }) : void 0)
        },
        ...
        buildMutatedEventInstanceGroup: function(t, e) {
            ...
            for (n = 0; n < r.length; n++)
                (i = r[n].clone())instanceof $e && (e.mutateSingle(i),
                s.push.apply(s, i.buildInstances()));
            return new Je(s)
        },
        freeze: function() {
    ...
    var Ye = {
      ...
      , Qe = Wt.EventDef = dt.extend(oe, {
        ...
        applyManualStandardProps: function(e) {
            return null != e.id ? this.id = Qe.normalizeId(this.rawId = e.id) : this.id = Qe.generateId(),
            null != e._id ? this.uid = String(e._id) : this.uid = Qe.generateId(),
    ...
    var Xe = Qe.extend({
        ...
        buildInstances: function(t) {
            for (var e, n, i, r = this.source.calendar, s = t.getStart(), o = t.getEnd(), a = []; s.isBefore(o); )
                this.dowHash && !this.dowHash[s.day()] || (e = r.applyTimezone(s),
                n = e.clone(),
                i = null,
    ...
    var Ke = dt.extend({
      ...
      , Je = Wt.EventInstanceGroup = dt.extend({
        ...
        sliceNormalRenderRanges: function(t) {
            ...
            for (e = 0; e < r.length; e++)
                n = r[e],
                (i = n.dateProfile.unzonedRange.intersect(t)) && s.push(new en(i,n.def,n));
            return s
        },
    ...
    tn.parse = function(t, e) {
        ...
        return !!s.isValid() && (!o || o.isValid() && o.isAfter(s) || (o = null),
        null == a && null == (a = e.allDayDefault) && (a = r.opt("allDayDefault")),
        !0 === a ? (s.stripTime(),
        o && o.stripTime()) : !1 === a && (s.hasTime() || s.time(0),
    ...
    var en = dt.extend({
      ...
      , rn = Wt.EventDefMutation = dt.extend({
        ...
        mutateSingle: function(t) {
            ...
            null != this.eventDefId && (t.id = Qe.normalizeId(t.rawId = this.eventDefId)),
            this.className && (t.className = this.className),
            this.verbatimStandardProps && $e.copyVerbatimStandardProps(this.verbatimStandardProps, t),
    ...
    sn.createFromDiff = function(t, e, n) {
        ...
        return r = i(e.start, t.start),
        e.end && (s = i(e.unzonedRange.getEnd(), t.unzonedRange.getEnd()),
        o = s.subtract(r)),
        a = new sn,
        a.clearEnd = l,
        a.forceTimed = u,
    ...
    var on = dt.extend(oe, {
        ...
        parseEventDefs: function(t) {
            var e, n, i = [];
            for (e = 0; e < t.length; e++)
                (n = Ze.parse(t[e], this)) && i.push(n);
            return i
        },
        applyManualStandardProps: function(e) {
            return null != e.id && (this.id = on.normalizeId(e.id)),
            ...
            ce.construct(function(e, n) {
                t.ajax(t.extend({}, cn.AJAX_DEFAULTS, s, {
                    ...
                    success: function(i) {
                        ...
                        i ? (s = $(o, this, arguments),
                        t.isArray(s) && (i = s),
                        e(r.parseEventDefs(i))) : n()
                    },
                    error: function() {
                        r.calendar.popLoading(),
                        $(a, this, arguments),
    ...
    var vn = xe.extend({
        ...
        renderFillRow: function(e, n) {
            ...
            return i = "businessHours" === e ? "bgevent" : e.toLowerCase(),
      ...
      , mn = He.extend({
        ...
        fgSegHtml: function(t, e) {
            ...
            t.isStart && (n = this.getTimeText(t.footprint)) && (d = '<span class="fc-time">' + et(n) + "</span>"),
            i = '<span class="fc-title">' + (et(s.title || "") || "&nbsp;") + "</span>",
            '<a class="' + c.join(" ") + '"' + (s.url ? ' href="' + et(s.url) + '"' : "") + (h ? ' style="' + h + '"' : "") + '><div class="fc-content">' + (this.isRTL ? i + " " + d : d + " " + i) + "</div>" + (l ? '<div class="fc-resizer fc-start-resizer" />' : "") + (u ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
        }
    })
      , yn = Pe.extend({
        renderSegs: function(e, n) {
            var i, r = [];
            return i = this.eventRenderer.renderSegRows(e),
            this.component.rowEls.each(function(e, s) {
                var o, a, l = t(s), u = t('<div class="fc-helper-skeleton"><table/></div>');
                n && n.row === e ? a = n.el.position().top : (o = l.find(".fc-content-skeleton tbody"),
      ...
      , wn = Wt.DayGrid = ke.extend(Ie, Be, {
        ...
        renderNumberCellHtml: function(t) {
            ...
            return o || this.cellWeekNumbersVisible ? (e = this.getDayClasses(t),
    ...
    wn.mixin({
        ...
        renderSegPopoverContent: function(e, n, i) {
            ...
            for (i = this.eventRenderer.renderFgSegEls(i, !0),
            this.popoverSegs = i,
            r = 0; r < i.length; r++)
                this.hitsNeeded(),
        ...
        resliceDaySegs: function(e, n) {
            ...
            for (i = 0; i < e.length; i++)
                r = e[i],
                (s = r.footprint.componentFootprint.unzonedRange.intersect(l)) && u.push(t.extend({}, r, {
            ...
            return this.eventRenderer.sortEventSegs(u),
            u
        },
    ...
    var Dn = Wt.BasicView = Ae.extend({
        ...
        constructor: function() {
            ...
            this.opt("weekNumbers") && (this.opt("weekNumbersWithinDays") ? (this.dayGrid.cellWeekNumbersVisible = !0,
            this.dayGrid.colWeekNumbersVisible = !1) : (this.dayGrid.cellWeekNumbersVisible = !1,
        ...
        buildRenderRange: function(t, e, n) {
            ...
            return /^(year|month)$/.test(e) && (r.startOf("week"),
        ...
        updateSize: function(t, e, n) {
            ...
            if (!this.dayGrid.rowEls)
                return void (e || (s = this.computeScrollerHeight(t),
                this.scroller.setHeight(s)));
            Ae.prototype.updateSize.apply(this, arguments),
            this.dayGrid.colWeekNumbersVisible && (this.weekNumberWidth = u(this.el.find(".fc-week-number"))),
            this.scroller.clear(),
            r(l),
            ...
            a && "number" != typeof a && this.dayGrid.limitRows(a),
            e || (this.scroller.setHeight(s),
            o = this.scroller.getScrollbarWidths(),
            (o.left || o.right) && (i(l, o),
            s = this.computeScrollerHeight(t),
            this.scroller.setHeight(s)),
      ...
      , En = Wt.MonthView = Dn.extend({
        buildRenderRange: function(t, e, n) {
            ...
            return this.isFixedWeeks() && (i = Math.ceil(o.diff(s, "weeks", !0)),
            o.add(6 - i, "weeks")),
            new Ue(s,o)
        },
        setGridHeight: function(t, e) {
    ...
    var Sn = xe.extend({
      ...
      , Rn = Pe.extend({
        renderSegs: function(e, n) {
            var i, r, s, o = [];
            for (this.eventRenderer.renderFgSegsIntoContainers(e, this.component.helperContainerEls),
            i = 0; i < e.length; i++)
                r = e[i],
      ...
      , Tn = Wt.TimeGrid = ke.extend(Ie, Be, {
        ...
        renderSlatRowHtml: function() {
            for (var t, n, i, r = this.view, s = r.calendar, o = s.theme, a = this.isRTL, l = this.dateProfile, u = "", c = e.duration(+l.minTime), h = e.duration(0); c < l.maxTime; )
                ...
                i = '<td class="fc-axis fc-time ' + o.getClass("widgetContent") + '" ' + r.axisStyleAttr() + ">" + (n ? "<span>" + et(t.format(this.labelFormat)) + "</span>" : "") + "</td>",
                u += '<tr data-time="' + t.format("HH:mm:ss") + '"' + (n ? "" : ' class="fc-minor"') + ">" + (a ? "" : i) + '<td class="' + o.getClass("widgetContent") + '"/>' + (a ? i : "") + "</tr>",
      ...
      , In = Wt.AgendaView = Ae.extend({
        ...
        updateSize: function(t, e, n) {
            var s, o, a;
            if (Ae.prototype.updateSize.apply(this, arguments),
            this.axisWidth = u(this.el.find(".fc-axis")),
            !this.timeGrid.colEls)
                return void (e || (o = this.computeScrollerHeight(t),
            ...
            e || (o = this.computeScrollerHeight(t),
            this.scroller.setHeight(o),
            a = this.scroller.getScrollbarWidths(),
            (a.left || a.right) && (i(l, a),
    ...
    var zn = Wt.ListView = Ae.extend({
        ...
        eventRendererClass: He.extend({
            ...
            fgSegHtml: function(t) {
                ...
                return e = a.isAllDay ? n.getAllDayHtml() : n.isMultiDayRange(a.unzonedRange) ? t.isStart || t.isEnd ? et(this._getTimeText(i.msToMoment(t.startMs), i.msToMoment(t.endMs), a.isAllDay)) : n.getAllDayHtml() : et(this.getTimeText(s)),
                l && u.push("fc-has-url"),
                '<tr class="' + u.join(" ") + '">' + (this.displayEventTime ? '<td class="fc-list-item-time ' + r.getClass("widgetContent") + '">' + (e || "") + "</td>" : "") + '<td class="fc-list-item-marker ' + r.getClass("widgetContent") + '"><span class="fc-event-dot"' + (c ? ' style="background-color:' + c + '"' : "") + '></span></td><td class="fc-list-item-title ' + r.getClass("widgetContent") + '"><a' + (l ? ' href="' + et(l) + '"' : "") + ">" + et(o.title || "") + "</a></td></tr>"
            },
            computeEventTimeFormat: function() {
